...
class ProductDetailPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__image = new ObservedPropertyObjectPU({ "id": 16777307, "type": 20000, params: [], "bundleName": "com.example.newsrelease", "moduleName": "entry" }, this, "image");
    ...
    aboutToAppear(): void {
        ...
        if (params) {
            ...
            if (foundProduct) { //如果找到匹配的产品，直接使用该产品对象
                ...
                // 使用默认值创建产品
                this.product = new ProductItem(this.productId, routeParams.name || '', parseFloat(routeParams.price || '0'), parseFloat(routeParams.rating || '0'), { "id": 16777307, "type": 20000, params: [], "bundleName": "com.example.newsrelease", "moduleName": "entry" });
            }
