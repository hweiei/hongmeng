        ...
        return new Promise(async (resolve: Function, reject: Function) => {
            ...
            httpRequestGet(url).then((data: ResponseResult) => {
                ...
                if (data.code === Constants.SERVER_CODE_SUCCESS) {
                    ...
                    reject({ "id": 16777228, "type": 10003, params: [], "bundleName": "com.example.newsrelease", "moduleName": "entry" }); // 返回错误提示
                }
            }).catch((err: Error) => {
                Logger.error('getNewsList failed', JSON.stringify(err)); // 记录异常日志
                reject({ "id": 16777226, "type": 10003, params: [], "bundleName": "com.example.newsrelease", "moduleName": "entry" }); // 返回网络错误提示
            });
        });
    }
    /**
        ...
        return new Promise((resolve: Function, reject: Function) => {
            ...
            httpRequestPost(url, newsData).then((result: ResponseResult) => {
                ...
                if (result && result.code === Constants.SERVER_CODE_SUCCESS) {
                    ...
                    reject({ "id": 16777250, "type": 10003, params: [], "bundleName": "com.example.newsrelease", "moduleName": "entry" }); // 返回上传错误提示
                }
            }).catch((err: Error) => {
